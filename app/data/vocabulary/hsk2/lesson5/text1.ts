    ...
    lines: [
      {
        ...
        pinyin: "Jiāyuè, kuài xiàlái ba, dì-yī cì qù Zhōngguó péngyou jiā, bié wǎn le.",
        english: "Jiayue, come down quickly. It's your first time going to a Chinese friend's home, so don't be late.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "还有时间，你上来吧。",
      ...
      },
      {
        ...
        english: "It's okay. Sister Yixue said that arriving before 11 o'clock is fine.",
      },
    ],
  },
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "速", pinyin: "sù", english: "Fast" },
      ],
    },
    {
      hanzi: "下来",
    ...
    },
    {
      ...
      similar: [
        { hanzi: "登", pinyin: "dēng", english: "Ascend" },
      ],
    },
    {
      hanzi: "下面",
      ...
      similar: [
        { hanzi: "底下", pinyin: "dǐxia", english: "Underneath" },
      ],
    },
    {
      hanzi: "面",
      ...
      bangla: "পাশ/তল",
      characters: [
        { hanzi: "面", pinyin: "miàn", meaning: "Face/Surface" },
      ],
      example: {
        hanzi: "他在我前面。",
    ...
    },
    {
      ...
      bangla: "অপেক্ষা করা",
      characters: [
        { hanzi: "等", pinyin: "děng", meaning: "Wait" },
      ],
      example: {
        hanzi: "请等一会儿。",
      ...
      similar: [
        { hanzi: "候", pinyin: "hòu", english: "Wait" },
      ],
    },
    {
      hanzi: "一会儿",
      ...
      similar: [
        { hanzi: "一下", pinyin: "yíxià", english: "A bit" },
      ],
    },
    {
      hanzi: "下去",
      ...
      similar: [
        { hanzi: "降", pinyin: "jiàng", english: "Descend" },
      ],
    },
  ],
};
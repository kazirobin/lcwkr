...
export const hsk2lesson5text2: VocabularyData = {
    ...
    lines: [
      {
        ...
        pinyin: "Jiāyuè, Ānnī, kuài jìnlái! Wǒ gěi nǐmen jièshào yíxià, zhè shì háizimen de yéye, nǎinai.",
        english: "Jiayue, Anni, come in quickly! Let me introduce you. These are the children's grandfather and grandmother.",
      },
      {
      ...
      },
      {
        ...
        pinyin: "Bà, mā, zhè shì Bái Jiāyuè, zhè shì Ānnī. Tāmen dōu shì Yīfēi de xuésheng.",
        english: "Dad, Mom, this is Bai Jiayue, and this is Anni. They are both Yifei's students.",
      },
      {
        speaker: "Liu Yeye",
        hanzi: "家月、安妮，你们好！",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      similar: [
        { hanzi: "打算", pinyin: "dǎsuàn", english: "Plan" },
      ],
    },
  ],
};
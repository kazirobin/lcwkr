...
export const hsk2lesson4text2: VocabularyData = {
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "You have a lot of white clothes. Why are you still buying white ones?",
      },
      {
        speaker: "Liu Xiaoxue",
        hanzi: "因为我喜欢白色啊！",
      ...
      },
      {
        ...
        pinyin: "Wǒ juéde zhè tiáo báisè de bú tài hǎokàn, nǐ shìshi nà tiáo hóngsè de ba.",
        english: "I don't think these white ones look very good. Try that red pair.",
      },
      {
        speaker: "Liu Xiaoxue",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      characters: [
        { hanzi: "试", pinyin: "shì", meaning: "Try/Test" },
      ],
      example: {
        hanzi: "我可以试一下这件衣服吗？",

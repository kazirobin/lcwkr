  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Běijīng zhè jǐ tiān suīrán shì qíngtiān, dànshì yǒudiǎnr lěng.",
        english: "Although it has been sunny in Beijing these days, it is a little cold.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "我这里比北京冷多了，外边还正下着雪呢！",
        pinyin: "Wǒ zhèlǐ bǐ Běijīng lěng duō le, wàibian hái zhèng xiàzhe xuě ne!",
        english: "It is much colder here than in Beijing. It is even snowing outside!",
      },
    ],
  },
  vocabulary: [

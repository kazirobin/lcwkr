  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "There was too much work, and I hadn't finished it when it was time to get off work.",
      },
      {
        speaker: "Wang Yixue",
        hanzi: "菜都做好了，过来吃饭吧。",
      ...
      },
      {
        ...
        english: "Then think about it some more. Once you've decided, I'll buy the tickets.",
      },
    ],
  },
  vocabulary: [
    ...
    },
    {
      ...
      similar: [
        { hanzi: "这样", pinyin: "zhèyàng", english: "This way/Such" },
      ],
    },
    {
      hanzi: "完",
      ...
      characters: [
        { hanzi: "完", pinyin: "wán", meaning: "Finish/Complete" },
      ],
      example: {
        hanzi: "我做完了我的工作。",
      ...
      similar: [
        { hanzi: "结束", pinyin: "jiéshù", english: "Finish/End" },
      ],
    },
  ],
};
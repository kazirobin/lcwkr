...
export const hsk2lesson8text1: VocabularyData = {
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "I also think the one on the left looks better than the one on the right.",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "你看看要多少钱！",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      similar: [
        { hanzi: "左侧", pinyin: "zuǒcè", english: "Left side" },
      ],
    },
    {
      hanzi: "左",
    ...
    },
    {
      ...
      similar: [
        { hanzi: "比较", pinyin: "bǐjiào", english: "Compare" },
      ],
    },
    {
      hanzi: "右边",
      ...
      similar: [
        { hanzi: "右侧", pinyin: "yòucè", english: "Right side" },
      ],
    },
    {
      hanzi: "右",

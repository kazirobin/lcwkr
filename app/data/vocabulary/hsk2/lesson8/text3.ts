  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Shēngrì kuàilè! Suīrán nǐ wàng le, dànshì wǒ jìde. Kànkan zhè shì shénme?",
        english: "Happy birthday! Although you forgot, I remembered. Look, what is this?",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "手表！吃饭、看电影、买手表，今天花了不少钱吧？",
        pinyin: "Shǒubiǎo! Chīfàn, kàn diànyǐng, mǎi shǒubiǎo, jīntiān huā le bù shǎo qián ba?",
        english: "A watch! We ate, watched a movie, and bought a watch. We spent quite a lot of money today, didn't we?",
      },
      {
        speaker: "Liu Ming",
        hanzi: "虽然花了一些钱，但是我们过了一个快乐的生日。",
        pinyin: "Suīrán huā le yìxiē qián, dànshì wǒmen guò le yí ge kuàilè de shēngrì.",
  ...
  vocabulary: [
    {
      ...
      bangla: "অর্ডার করা",
      characters: [
        { hanzi: "点", pinyin: "diǎn", meaning: "To order/Dot" },
      ],
      example: {
        hanzi: "我们点菜吧。",
      ...
      similar: [
        { hanzi: "订", pinyin: "dìng", english: "To book/order" },
      ],
    },
    {
      hanzi: "虽然",
      ...
      similar: [
        { hanzi: "尽管", pinyin: "jǐnguǎn", english: "Although" },
      ],
    },
    {
      hanzi: "但是",

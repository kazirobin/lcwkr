  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "Yesterday afternoon. Tianzhong, why did you run outside as soon as class ended?",
      },
      {
        speaker: "Chen Tianzhong",
        hanzi: "我跟同学说好了，一起去打篮球。",
        pinyin: "Wǒ gēn tóngxué shuō hǎo le, yìqǐ qù dǎ lánqiú.",
        english: "I made plans with my classmates to go play basketball together.",
      },
      {
        speaker: "Anni",
        hanzi: "我也想跟你们一起玩。",
  ...
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "自", pinyin: "zì", english: "From" },
      ],
    },
    {
      hanzi: "往",
      ...
      bangla: "দিকে/যাওয়া",
      characters: [
        { hanzi: "往", pinyin: "wǎng", meaning: "Towards" },
      ],
      example: {
        hanzi: "往前走。",
      ...
      similar: [
        { hanzi: "向", pinyin: "xiàng", english: "Towards" },
      ],
    },
    {
      hanzi: "跑",
      ...
      similar: [
        { hanzi: "奔", pinyin: "bēn", english: "Run" },
      ],
    },
    {
      hanzi: "打",
      ...
      characters: [
        { hanzi: "打", pinyin: "dǎ", meaning: "Hit/Play" },
      ],
      example: {
        hanzi: "我们打篮球吧。",
    ...
    },
    {
      ...
      similar: [
        { hanzi: "皮球", pinyin: "píqiú", english: "Ball" },
      ],
    },
  ],
};
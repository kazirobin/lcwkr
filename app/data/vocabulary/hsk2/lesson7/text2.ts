  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Wǒ hái xǐhuan tī zúqiú, yí dào Xīngqītiān jiù gēn péngyoumen qù tī qiú.",
        english: "I also like playing soccer. As soon as Sunday comes, I go play soccer with my friends.",
      },
      {
        speaker: "Anni",
        hanzi: "你踢得怎么样？",
  ...
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "锻炼", pinyin: "duànliàn", english: "Exercise" },
      ],
    },
    {
      hanzi: "踢",

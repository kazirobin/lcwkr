  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "Okay. Now I will say them, and you write them in your notebooks.",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "同学们，'洗手间'的'间'字写错了，它的里面是'日'，不是'口'。",
        pinyin: "Tóngxuémen, 'xǐshǒujiān' de 'jiān' zì xiěcuò le. Tā de lǐmiàn shì 'rì', bú shì 'kǒu'.",
        english: "Students, you wrote the character '间' in '洗手间' incorrectly. The inside is '日', not '口'.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "'日'比'口'多一笔，写'口'就是'问题'的'问'了。",
        pinyin: "'Rì' bǐ 'kǒu' duō yì bǐ, xiě 'kǒu' jiù shì 'wèntí' de 'wèn' le.",
        english: "'日' has one more stroke than '口'. If you write '口', it becomes the '问' in '问题'.",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "没错，你说得很对。",
  ...
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "上边", pinyin: "shàngbian", english: "Above" },
      ],
    },
    {
      hanzi: "洗手间",
      ...
      similar: [
        { hanzi: "厕所", pinyin: "cèsuǒ", english: "Toilet" },
      ],
    },
    {
      hanzi: "里面",
      ...
      similar: [
        { hanzi: "里边", pinyin: "lǐbian", english: "Inside" },
      ],
    },
    {
      hanzi: "笔",

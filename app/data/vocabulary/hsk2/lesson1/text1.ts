  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Nǐmen hǎo, wǒ jiào Wáng Yīxuě. Yīfēi gěi wǒ dǎ diànhuà le, ràng wǒ lái jiē nǐmen.",
        english: "Hello. My name is Wang Yixue. Yifei called me and asked me to come pick you up.",
      },
      {
  ...
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "正", pinyin: "zhèng", english: "Exactly" },
      ],
    },
    {
      hanzi: "给",
      ...
      similar: [
        { hanzi: "为", pinyin: "wèi", english: "For" },
      ],
    },
    {
      hanzi: "让",
      ...
      similar: [
        { hanzi: "叫", pinyin: "jiào", english: "Let/Make/Call" },
      ],
    },
    {
      hanzi: "接",
      ...
      similar: [
        { hanzi: "迎", pinyin: "yíng", english: "Welcome/Meet" },
      ],
    },
  ],
};
...
export const hsk2lesson1text3: VocabularyData = {
    ...
    lines: [
      {
        ...
        pinyin: "Wéi, Jiāyuè, nǐ míngtiān yǒu shíjiān ma? Wǒ xiǎng qǐng nǐ bāng ge máng.",
        english: "Hello, Jiayue. Do you have time tomorrow? I want to ask you for a favor.",
      },
      {
        speaker: "Bai Jiayue",
      ...
      },
      {
        ...
        pinyin: "Wǒ shì jīntiān zǎoshang dào de. Nǐ yǒu shì kěyǐ jiào Lǐ Wén bāngmáng, tā hái zài xuéxiào ne.",
        english: "I arrived this morning. If you need help, you can ask Li Wen. He is still at school.",
      },
      {
        speaker: "Chen Tianzhong",
        hanzi: "好的，那我给他打个电话。",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      characters: [
        { hanzi: "那", pinyin: "nà", meaning: "That/Then" },
      ],
      example: {
        hanzi: "那我们明天去吧。",
      ...
      similar: [
        { hanzi: "那么", pinyin: "nàme", english: "Then/So" },
      ],
    },
  ],
};
...
export const hsk2lesson2text2: VocabularyData = {
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "Yes, Peking University has more than forty thousand students!",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "你是怎么知道的？",
      ...
      },
      {
        ...
        pinyin: "Shì wǎngshàng shuō de, wǎngshàng hái shuō Běijīng Dàxué yǒu sānqiān duō míng wàiguó xuéshēng.",
        english: "I read it online. It also says online that Peking University has more than three thousand international students.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "我也想来这儿学习。",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      characters: [
        { hanzi: "名", pinyin: "míng", meaning: "Name/Status" },
      ],
      example: {
        hanzi: "我们班来了三名新学生。",
    ...
    },
    {
      ...
      characters: [
        { hanzi: "间", pinyin: "jiān", meaning: "Room/Space" },
      ],
      example: {
        hanzi: "这间教室很大。",

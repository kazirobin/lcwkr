  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "Dad will help you this time. Next time, you prepare everything yourself, okay?",
      },
      {
        speaker: "Liu Xiaoming",
        hanzi: "好！",
  ...
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "开课", pinyin: "kāikè", english: "Class starts" },
      ],
    },
    {
      hanzi: "门",
      ...
      similar: [
        { hanzi: "门口", pinyin: "ménkǒu", english: "Entrance" },
      ],
    },
    {
      hanzi: "后面",
      ...
      similar: [
        { hanzi: "后方", pinyin: "hòufāng", english: "Rear/Behind" },
      ],
    },
    {
      hanzi: "笔",
    ...
    },
    {
      ...
      bangla: "সাহায্য করা",
      characters: [
        { hanzi: "帮", pinyin: "bāng", meaning: "To help" },
      ],
      example: {
        hanzi: "你能帮我吗？",

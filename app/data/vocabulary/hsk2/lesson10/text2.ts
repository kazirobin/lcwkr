  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        english: "I've already reviewed them, and I understand all the meanings.",
      },
      {
        speaker: "Wang Yixue",
        hanzi: "你的本子呢？本子上做错的题也要看一看。",
        pinyin: "Nǐ de běnzi ne? Běnzi shàng zuòcuò de tí yě yào kàn yi kàn.",
        english: "What about your notebook? You should also review the questions you got wrong in the notebook.",
      },
      {
        speaker: "Liu Xiaoxue",
        hanzi: "妈妈，是您准备考试还是我准备考试？",
        pinyin: "Māma, shì nín zhǔnbèi kǎoshì háishì wǒ zhǔnbèi kǎoshì?",
        english: "Mom, are you preparing for the exam, or am I preparing for the exam?",
      },
    ],
  },
  vocabulary: [

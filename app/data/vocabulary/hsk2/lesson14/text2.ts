...
export const hsk2lesson14text2: VocabularyData = {
  ...
  dialogue: {
    ...
    lines: [
      {
        speaker: "Wang Yifei",
        hanzi: "同乐，真是你啊！上次打电话，你说有时间过来看我，没想到这么快就来了！",
        pinyin: "Tónglè, zhēn shì nǐ a! Shàng cì dǎ diànhuà, nǐ shuō yǒu shíjiān guòlái kàn wǒ, méi xiǎngdào zhème kuài jiù lái le!",
        english: "Tongle, it's really you! Last time we talked on the phone, you said you'd come to see me when you had time. I didn't expect you to come so soon!",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "你在中国过年吗？",
      ...
      },
      {
        ...
        english: "That's great! But spending the New Year all alone is so boring!",
      },
      {
        speaker: "Zhou Tongle",
      ...
      },
      {
        ...
        english: "Is it your girlfriend? Quickly bring her over and let me see her!",
      },
      {
        speaker: "Zhou Tongle",
        hanzi: "她在前面那家咖啡店等我呢。",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      similar: [
        { hanzi: "无聊", pinyin: "wúliáo", english: "Boring" },
      ],
    },
    {
      hanzi: "位",
      ...
      characters: [
        { hanzi: "位", pinyin: "wèi", meaning: "Position/Person" },
      ],
      example: {
        hanzi: "这位是林老师。",
    ...
    },
    {
      ...
      similar: [
        { hanzi: "前方", pinyin: "qiánfāng", english: "Ahead" },
      ],
    },
  ],
};
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Hǎo de. Měitiān shàngxiàbān dōu zuò chē, jīntiān yùndòng yùndòng ba.",
        english: "Okay. We take a vehicle to and from work every day, so let's get some exercise today.",
      },
    ],
  },
  vocabulary: [
    {
      ...
      similar: [
        { hanzi: "靠近", pinyin: "kàojìn", english: "Near" },
      ],
    },
    {
      hanzi: "走路",

...
export const hsk2lesson9text1: VocabularyData = {
  ...
  dialogue: {
    ...
    lines: [
      ...
      },
      {
        ...
        pinyin: "Pángbiān nàge nánháir jiù chuān le zhèyàng de kùzi, wǒ juéde hěn hǎokàn a!",
        english: "The boy over there is wearing pants like these. I think they look very nice!",
      },
      {
        speaker: "Liu Ming",
        hanzi: "儿子的个子没有他那么高，穿上就不会太好看。",
        pinyin: "Érzi de gèzi méiyǒu tā nàme gāo, chuānshàng jiù bú huì tài hǎokàn.",
        english: "Our son isn't as tall as him, so they won't look very good on him.",
      },
      {
        speaker: "Wang Yixue",
        hanzi: "好吧，我们再去那边看看。",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      similar: [
        { hanzi: "那样", pinyin: "nàyàng", english: "Like that" },
      ],
    },
    {
      hanzi: "高",

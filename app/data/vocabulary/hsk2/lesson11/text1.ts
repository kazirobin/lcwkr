...
export const hsk2lesson11text1: VocabularyData = {
    ...
    lines: [
      {
        ...
        english: "Jiayue, class is already over. Why aren't you going home yet?",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "我头疼，不太舒服。",
      ...
      },
      {
        ...
        english: "You've been having headaches often these past few days. You should go to the hospital and get checked.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "我想休息一下，现在不能动，一动就疼。",
        pinyin: "Wǒ xiǎng xiūxi yíxià, xiànzài bù néng dòng, yí dòng jiù téng.",
        english: "I want to rest for a while. I can't move right now; it hurts whenever I move.",
      },
      {
        speaker: "Wang Yifei",
        hanzi: "那你在这儿坐着，我去开车，一会儿送你去医院。",
        pinyin: "Nà nǐ zài zhèr zuòzhe, wǒ qù kāichē, yíhuìr sòng nǐ qù yīyuàn.",
        english: "Then sit here. I'll go get the car and take you to the hospital in a little while.",
      },
      {
        speaker: "Bai Jiayue",
        hanzi: "谢谢王老师。",
  ...
  vocabulary: [
    ...
    },
    {
      ...
      characters: [
        { hanzi: "着", pinyin: "zhe", meaning: "Aspect particle" },
      ],
      example: {
        hanzi: "门开着。",
        pinyin: "Mén kāi zhe.",
